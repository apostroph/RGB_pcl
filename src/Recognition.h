...
private:
  ...
  void drawPointCloud(pcl::PointCloud<pcl::PointXYZRGB> combinedCloud, Mat displayImage);
  void drawTrackers(Mat &img, track_3d input_tracker, string name);
  ...
  void loadHistogram();
  void get_cloud_matching(PointCloudPtr cloud);
  double MatchingMethod(Mat img, MatND hist_templ, Mat &result, int match_method = 1);
